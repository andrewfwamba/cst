  ...
  return (
    <>
      <div className="grid lg:grid-cols-2 gap-2 p-4">
        {/* Choices 1st */}
        <div className="bg-gray-100 rounded p-4 lg:mx-0 ">
          ...
          {/* Mobile dev portion */}
          <div className="bg-gray-300  rounded p-4 shadow mb-4 shadow-blue-400 ">
            <div className="flex">
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="w-8 h-8 text-blue-800 mr-8"
              >
                <path
          ...
          <div className="bg-gray-300  rounded p-4 shadow shadow-blue-400 mb-4">
            <div className="flex">
              <FcKindle size={30} />
          ...
          {/* UI/UX */}
          <div className="bg-gray-300  rounded p-4 shadow shadow-blue-400 ">
            <div className="flex">
              <FcMultipleSmartphones size={35} />
              <h2 className="text-2xl text-gray-500 ml-4">
